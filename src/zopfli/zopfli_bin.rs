...
*/
    ...
    fn ZopfliCompress(options: *const ZopfliOptions,
                      output_type: ZopfliFormat, in_0: *const libc::c_uchar,
                      insize: size_t, out: *mut *mut libc::c_uchar,
                      outsize: *mut size_t);
}
...
*/
unsafe extern "C" fn LoadFile(mut filename: *const libc::c_char,
                              mut out: *mut *mut libc::c_uchar,
                              mut outsize: *mut size_t) -> libc::c_int {
    ...
    *out = malloc(*outsize) as *mut libc::c_uchar;
    if *outsize != 0 && !(*out).is_null() {
        let mut testsize: size_t =
            fread(*out as *mut libc::c_void, 1 as libc::c_int as size_t,
                  *outsize, file);
        if testsize != *outsize {
            /* It could be a directory */
            free(*out as
                     *mut libc::c_void); /* If size is not zero, out must be allocated. */
            *out = 0 as *mut libc::c_uchar;
            *outsize = 0 as libc::c_int as size_t;
            fclose(file);
    ...
    if *outsize == 0 || !out.is_null() {
        ...
        __assert_fail(b"!(*outsize) || out\x00" as *const u8 as
                          *const libc::c_char,
                      b"src/zopfli/zopfli_bin.c\x00" as *const u8 as
                          *const libc::c_char,
                      76 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 55],
                                                &[libc::c_char; 55]>(b"int LoadFile(const char *, unsigned char **, size_t *)\x00")).as_ptr());
    };
    fclose(file);
...
*/
unsafe extern "C" fn SaveFile(mut filename: *const libc::c_char,
    ...
    if !file.is_null() {
        ...
        __assert_fail(b"file\x00" as *const u8 as *const libc::c_char,
                      b"src/zopfli/zopfli_bin.c\x00" as *const u8 as
                          *const libc::c_char,
                      91 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 59],
                                                &[libc::c_char; 59]>(b"void SaveFile(const char *, const unsigned char *, size_t)\x00")).as_ptr());
    };
    fwrite(in_0 as *mut libc::c_char as *const libc::c_void,
           1 as libc::c_int as size_t, insize, file);
    fclose(file);
}
/*
outfilename: filename to write output to, or 0 to write to stdout instead
*/
unsafe extern "C" fn CompressFile(mut options: *const ZopfliOptions,
    ...
    ZopfliCompress(options, output_type, in_0, insize, &mut out,
                   &mut outsize);
    if !outfilename.is_null() {
        SaveFile(outfilename, out, outsize);
    } else {
        fwrite(out as *const libc::c_void, 1 as libc::c_int as size_t,
               outsize, stdout);
    }
...
*/
unsafe extern "C" fn AddStrings(mut str1: *const libc::c_char,
                                mut str2: *const libc::c_char)
 -> *mut libc::c_char {
    let mut len: size_t =
        strlen(str1).wrapping_add(strlen(str2)); /* Allocation failed. */
    let mut result: *mut libc::c_char =
        malloc(len.wrapping_add(1 as libc::c_int as libc::c_ulong)) as
            *mut libc::c_char;
    if result.is_null() { exit(-(1 as libc::c_int)); }
    strcpy(result, str1);
    strcat(result, str2);
    return result;
}
unsafe extern "C" fn StringsEqual(mut str1: *const libc::c_char,
                                  mut str2: *const libc::c_char)
 -> libc::c_char {
    return (strcmp(str1, str2) == 0 as libc::c_int) as libc::c_int as
               libc::c_char;
}
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char)
 -> libc::c_int {
    let mut options: ZopfliOptions =
        ZopfliOptions{verbose: 0,
                      verbose_more: 0,
                      numiterations: 0,
                      blocksplitting: 0,
    ...
    while i < argc {
        ...
        if StringsEqual(arg, b"-v\x00" as *const u8 as *const libc::c_char) !=
               0 {
            options.verbose = 1 as libc::c_int
        } else if StringsEqual(arg,
            ...
            output_type = ZOPFLI_FORMAT_GZIP
                                 ...
                                 b"--splitlast\x00" as *const u8 as
                                     *const libc::c_char) != 0) {
            if *arg.offset(0 as libc::c_int as isize) as libc::c_int ==
                   ...
                   *arg.offset(2 as libc::c_int as isize) as libc::c_int ==
                       'i' as i32 &&
                   *arg.offset(3 as libc::c_int as isize) as libc::c_int >=
                       '0' as i32 &&
                   *arg.offset(3 as libc::c_int as isize) as libc::c_int <=
                       '9' as i32 {
                options.numiterations =
                    atoi(arg.offset(3 as libc::c_int as isize))
            } else if StringsEqual(arg,
        ...
        if *(*argv.offset(i as isize)).offset(0 as libc::c_int as isize) as
            ...
            if output_to_stdout != 0 {
                ...
                if output_type as libc::c_uint ==
                    ...
                    __assert_fail(b"output_type == ZOPFLI_FORMAT_DEFLATE\x00"
                                      as *const u8 as *const libc::c_char,
                                  b"src/zopfli/zopfli_bin.c\x00" as *const u8
                                      as *const libc::c_char,
